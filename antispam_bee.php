	...
	*/
	...
	private static function _map_lang_code( $franc_code ) {
		$codes = array(
			...
			'fas' => 'fa',
			'kan' => 'kn',
			'mai' => 'mai', // Seems not to have a ISO 639-1 code.
			'mal' => 'ml',
			'mya' => 'my',
			'ori' => 'or',
			'gax' => 'gax', // Seems not to have a ISO 639-1 code.
			'swh' => 'sw',
			'sun' => 'su',
			'ron' => 'ro',
			'pan' => 'pa',
			'bho' => 'bho', // Seems not to have a ISO 639-1 code.
			'amh' => 'am',
			'hau' => 'ha',
			'fuv' => 'ff',
			'bos' => 'bs',
			...
			'ibo' => 'ig',
			'nep' => 'ne',
			'ceb' => 'ceb', // Seems not to have a ISO 639-1 code.
			'skr' => 'skr', // Seems not to have a ISO 639-1 code.
			'tgl' => 'tl',
			'hun' => 'hu',
			'azj' => 'az',
			'sin' => 'si',
			'koi' => 'koi', // Seems not to have a ISO 639-1 code.
			'ell' => 'el',
			'ces' => 'cs',
			'run' => 'run', // Seems not to have a ISO 639-1 code.
			'bel' => 'be',
			'plt' => 'mg',
			'qug' => 'qug', // Seems not to have a ISO 639-1 code.
			'mad' => 'mad', // Seems not to have a ISO 639-1 code.
			'nya' => 'ny',
			'zyb' => 'zyb', // Seems not to have a ISO 639-1 code.
			'pbu' => 'pbu', // Seems not to have a ISO 639-1 code.
			'kin' => 'rw',
			'zul' => 'zu',
			'bul' => 'bg',
			'swe' => 'sv',
