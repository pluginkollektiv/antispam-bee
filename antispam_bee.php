...
*/
	...
	*/
	...
	public static function replace_comment_field_callback( $matches ) {
		...
		$output .= '</textarea><textarea id="comment" aria-hidden="true" name="comment" autocomplete="off" style="width:10px !important;position:absolute !important;left:-10000000px !important"></textarea>';
		$output .= $id_script;
