...
class Antispam_Bee {
	...
	*/
	...
	public static function replace_comment_field_callback( $matches ) {
		...
		$output .= '</textarea><textarea id="comment" hidden name="comment" autocomplete="new-password" style="padding:0;clip:rect(1px, 1px, 1px, 1px);position:absolute !important;white-space:nowrap;height:1px;width:1px;overflow:hidden;" tabindex="-1"></textarea>';
