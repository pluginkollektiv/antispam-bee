			...
			<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
				...
				<div class="ab-wrap">
					...
					<div class="ab-column ab-column--submit-service">
						...
						<p>
							<a href="<?php esc_attr_e( 'https://wordpress.org/plugins/antispam-bee/faq/', 'antispam-bee' ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'FAQ', 'antispam-bee' ); ?></a>
						</p>
						<p>
							<a href="<?php esc_attr_e( 'https://github.com/pluginkollektiv/antispam-bee/wiki/', 'antispam-bee' ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Manual', 'antispam-bee' ); ?></a>
						</p>
						<p>
							<a href="<?php esc_attr_e( 'https://wordpress.org/support/plugin/antispam-bee', 'antispam-bee' ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Support', 'antispam-bee' ); ?></a>
						</p>
