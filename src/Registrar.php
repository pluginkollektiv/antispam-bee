...
class Registrar {
	 ...
	 * @return bool
	 */
	public function register_filter( FilterInterface ...$filter_list ) {
	 ...
	 * @return bool
	 */
	public function register_post_processor( PostProcessorInterface ...$post_processor_list ) {
	 ...
	 */
	public function registered_filters() {
	 ...
	 */
	public function registered_post_processors() {
